...
<ImageGallery images={[
  { src: '/image/20240610235904.png', caption: '简单动态字符串' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240610235943.png', caption: '链表节点结构' },
]} />

链表结构，包含头节点、尾节点、节点数量、具体数据类型的处理函数指针，支持多态

<ImageGallery images={[
  { src: '/image/20240611000001.png', caption: '链表结构' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000022.png', caption: '哈希表' },
]} />

哈希表节点，保存了键、值和指向下一个节点的指针，通过链表解决哈希冲突

<ImageGallery images={[
  { src: '/image/20240611000038.png', caption: '哈希表节点' },
]} />

字典包含着两个哈希表、私有数据和类型特定的函数

<ImageGallery images={[
  { src: '/image/20240611000054.png', caption: '字典结构' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000127.png', caption: '跳跃表结构' },
]} />

表节点中保存着后退指针、分值、成员对象，还包括多个层，每层中保存前进指针和跨度

<ImageGallery images={[
  { src: '/image/20240611000200.png', caption: '跳跃表节点' },
]} />

跳跃表

<ImageGallery images={[
  { src: '/image/20240611000211.png', caption: '跳跃表' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000245.png', caption: '压缩列表' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000301.png', caption: '压缩列表节点结构' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000320.png', caption: '对象' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000338.png', caption: '文件事件处理器' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000403.png', caption: '时间事件处理器' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000421.png', caption: 'AOF持久化' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000447.png', caption: '数据库结构' },
  { src: '/image/20240611000507.png', caption: '过期时间与键空间' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240611000759.png', caption: '客户端结构' },
]} />
