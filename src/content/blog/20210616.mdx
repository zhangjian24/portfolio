...
<ImageGallery images={[
  { src: '/image/20240616221743.png', caption: '网卡1 配置' },
]} />

网卡2：

<ImageGallery images={[
  { src: '/image/20240616221757.png', caption: '网卡2 配置' },
  { src: '/image/20240616221811.png', caption: '网卡2 配置结果' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240616221829.png', caption: '查看虚拟机网卡名' },
]} />
