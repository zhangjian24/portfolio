---
title: "RAG系统性能优化实战：从评估不达标到全面通关的完整历程"
description: "基于阿里云百炼+pgvector的RAG系统优化实战，使用Ragas框架进行专业评估。详细记录从4项指标不达标到全面通过的完整优化过程，包含LLM-as-a-Judge评估器创建、Rerank API修复、配置参数调优、模型选型优化。最终所有指标达标，生成延迟下降34%，成本降低60%。"
pubDate: 2026-04-02
...
<ImageGallery images={[
  { src: 'https://img.jianzhang.cc/2026/04/756111b1f4e6b6de12930267844c59f2.png', caption: 'RAG系统问答界面' },
  { src: 'https://img.jianzhang.cc/2026/04/5357d4e09e4565b3975e40499af02f69.png', caption: 'RAG系统演示' },
]} />
