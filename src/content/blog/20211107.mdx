...
<ImageGallery images={[
  { src: '/image/20240616203224.png', caption: 'MySQL 架构' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240616203531.png', caption: '开启慢日志' },
  { src: '/image/20240616203547.png', caption: '测试慢日志' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240616203713.png', caption: '慢日志分析结果' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240616203755.png', caption: 'show profiles 记录列表' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240616203841.png', caption: 'show profile 分析结果' },
]} />
...
- 配置
  ...
  3. 在选定的主库上，配置二进制日志和唯一的服务器 ID，通过`show master status`命令检查配置
     ...
     # binlog_do_db		= include_database_name
      ...
      <ImageGallery images={[
        { src: '/image/20240616204124.png', caption: 'show master status 检查主库配置' },
      ]} />
   ...
   4. 在备库上，配置二进制日志和唯一的服务器 ID，运行`change master to`，通过`show slave status`检查备库状态
     ...
     ```bash
      ...
      <ImageGallery images={[
        { src: '/image/20240616204157.png', caption: 'show slave status 检查备库状态' },
      ]} />

   5. 在备库上，执行`start slave` 开始复制

      <ImageGallery images={[
        { src: '/image/20240616204225.png', caption: 'start slave 开始复制' },
      ]} />
...
<ImageGallery images={[
  { src: '/image/20240616204443.png', caption: '分库分表效果' },
]} />
...
<ImageGallery images={[
  { src: '/image/20240616204539.png', caption: '读写分离效果' },
]} />
